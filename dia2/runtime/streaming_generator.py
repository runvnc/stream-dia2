...
def run_streaming_generation(
    ...
    *,
    ...
    # DISABLED: Output all audio immediately for lowest latency.
    
    mimi_kv = None
    samples_to_skip = 0  # Don't skip any samples - output immediately
    print(f"[streaming] max_delay={max_delay}, samples_to_skip=0 (no skip)")
